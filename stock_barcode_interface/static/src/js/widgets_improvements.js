function openerp_picking_widgets(instance){
    ...
    module.PickingEditorWidget = instance.web.Widget.extend({
        ...
        renderElement: function(){
            ...
            this.$('.js_pick_print_all').click(function() {
                ...
                self.getParent().print_delivery_note();
                self.getParent().print_delivery_note();
            ...
            this.$('.js_pick_print_delivery_note').click(function() {
            	self.getParent().print_delivery_note();
            });
    ...
    module.PickingMainWidget = module.MobileWidget.extend({
        ...
        print_delivery_note: function(){
            var self = this;
            return new instance.web.Model('stock.picking').call('print_delivery_note',[[self.picking.id]])
               .then(function(action){
                    return self.do_action(action);
               });
